...
(function ($, window, undefined) {
    ...
    preTally.UserProfile = {
        ...
        menuMyUsername: function() { //05-12-2024
            if (!dhxMiddleBlockTabs.cells("menuMyUsername")) {
                dhxMiddleBlockTabs.addTab("menuMyUsername", "<img src='images/icon/user_icon_12.png' style='margin-top:2px;' />&nbsp;&nbsp;Manage Username", 160);
                dhxMiddleBlockTabs.tabs("menuMyUsername").setActive();
                addUsrNamForm = dhxMiddleBlockTabs.cells("menuMyUsername").attachForm();
                addUsrNamForm.loadStruct(preTally.Initialize.encryptURL("requisites/changeUsername.php"), function () {
                    addUsrNamForm.attachEvent("onButtonClick", function (name) {
                        if (name == 'newUsernameSave') {    
                            var validinp    = addUsrNamForm.validate();
                            var values      = addUsrNamForm.getFormData();
                            var vaiduser    = preTally.Validate.Validate(values, 'US_UName', addUsrNamForm, 'username');
                            if (validinp && vaiduser) {
                                //console.log("Validation Success");
                                preTally.Settings.progressOn(true, dhxLayout, null);
                                addUsrNamForm.send(preTally.Initialize.encryptURL('warehouse/changeUsername.php'), function (loader, response) {
                                    ...
                                    addUsrNamForm.resetValidateCss();
                                });
                            }
                        } else {
                            addUsrNamForm.resetValidateCss();
                ...
                addPasswordForm.loadStruct(preTally.Initialize.encryptURL("requisites/changePass.php"), function () {
                    ...
                    addPasswordForm.attachEvent("onButtonClick", function (name) {
                        if (name == 'newPasswordSave') {
                            ...
                            var values      = addPasswordForm.getFormData();
                            var passvalid3  = preTally.Validate.Validate(values, 'newPassword', addPasswordForm, 'password');
                            if (newItem && passvalid3 && addPasswordForm.getItemValue("newPassword") == addPasswordForm.getItemValue("rePassword") ) { 
                            // End Changes
                            //var newItem = addPasswordForm.validate();
                            //if (newItem) {
                                preTally.Settings.progressOn(true, dhxLayout, null);
                                ...
                                addPasswordForm.setValidateCss("rePassword", false, "validate_red");
        ...
        admResetPassword: function (usId) {
            ...
            passWin = dhxPassWin.createWindow("wins_pass", 350, 600, 400, 220);
            ...
            setPassForm.loadStruct(preTally.Initialize.encryptURL("requisites/admPassForm.php"), function () {
                ...
                setPassForm.attachEvent("onButtonClick", function (name) {
                    if (name == "admPassSave") {
                        var values      = setPassForm.getFormData();
                        var passvalid1  = preTally.Validate.Validate(values, 'newPassword', setPassForm, 'password');//04-12-2024
                        var passvalid2  = preTally.Validate.Validate(values, 'confrmPassword', setPassForm, 'password');//04-12-2024
        ...
        menuNewUser: function (usId, viewFlg) {
            ...
            if (!dhxMiddleBlockTabs.tabs(userModeForm)) {
                ...
                dhxLayout.cells("b").collapse(); // hide the right side common section 23-10-2025
                new_user_form[userModeForm].loadStruct(preTally.Initialize.encryptURL("requisites/newUser.php&" + params), function () {
                    ...
                    if (usId != '0') {
                        ...
                        // check the Designation History Shown or Hide 23-10-2025
                        var ShowHideDesgH = new_user_form[userModeForm].getItemValue("ShowHideDesgH");
                        if (ShowHideDesgH == '1') {
                            var EmpDesgHGrid = new dhtmlXGridObject(new_user_form[userModeForm].getContainer("empDesgHGrid"));
                            EmpDesgHGrid.enableColSpan(true);
                            var H_DG_Id   = new_user_form[userModeForm].getItemValue("H_DG_Id");
                            var HUS_MDate = new_user_form[userModeForm].getItemValue("HUS_MDate");
                            EmpDesgHGrid.loadXML(preTally.Initialize.encryptURL("requisites/listUsrDesgHistory.php&usid=" + us_id+"&desgid="+H_DG_Id+"&mdate="+HUS_MDate));
                        } 
                        // end designation history 24-10-2025
                    }
                    if (viewFlg != 1) {
                    ...
                    if (usId != 'self' && viewFlg != 1) {
                        ...
                        // Grace Time Section Hide or Show based on the user data 23-07-2025
                        new_user_form[userModeForm].getCalendar("Grace_End_Date").setSensitiveRange(new Date(), null);
                        if (new_user_form[userModeForm].getItemValue("ShowHideGrace") == 1 ) {
                            new_user_form[userModeForm].showItem('usr_grase_time');
                            new_user_form[userModeForm].setRequired("Grace_Reason", true);
                        } else {
                            new_user_form[userModeForm].hideItem('usr_grase_time'); 
                            new_user_form[userModeForm].setRequired("Grace_Reason", false);                            
                        }
                        // end grace time 23-07-2025
                    }
...
//                                US_ReportCombo.setComboText( new_user_form[userModeForm].getItemValue("H_US_Report_Name"));
                        ...
                        if (viewFlg != 1) {
                            ...
                            if (usId != 'self' && viewFlg != 1) { //26-03-2025 by Bilin
                                //var allowoffcbo = new_user_form[userModeForm].getCombo("Allow_OF_Work"); //28-03-25        
                                //allowoffcbo.setPlaceholder("Work Allowed Companies");
                            }
                        ...
                        ESCombo[userModeForm].attachEvent("onClose", function () {
                            ...
                            if (new_user_form[userModeForm].getItemValue("H_ES_Resign").split(',').includes(ESCombo[userModeForm].getSelectedValue())) {
                                dhtmlx.confirm({
                                    type: "confirm-warning",
                                    ok: "Yes", cancel: "No",
                    ...
                    new_user_form[userModeForm].attachEvent("onButtonClick", function (name) {
                        ...
                        } else if (name == 'doSentWelcomeMail')
                        {
                            ...
                            //console.log("new user and Edit User section....");
                            userModeForm        = dhxMiddleBlockTabs.getActiveTab();
                            ...
                            if (usId != 'self' && viewFlg != 1) {
                                ...
                                //28-03-2025
                                //var checkedoffids = allowoffcbo.getChecked();
                                //new_user_form[userModeForm].setItemValue('allowed_office', checkedoffids.toString());
                                //hide the above - not get ceo permission.


                                // start the time checking if the logined user have permission
                                // Date 23-07-2025
                                //console.log("Company Work Minutes ",new_user_form[userModeForm].getItemValue("com_total_time"));
                                //console.log("User Work Minutes Total",new_user_form[userModeForm].getItemValue("user_total_time"));
                                //console.log("Already Time Reduced or Not",new_user_form[userModeForm].getItemValue("US_Time_Reduced"));
                                //console.log("selected Times: ",logInTimeHr,":",logInTimeMin,":00  ", logOutTimeHr,":",logOutTimeMin,":00");
                                var fromTime    = new Date("2025-04-01T"+logInTimeHr+":"+logInTimeMin+":00");
                                var toTime      = new Date("2025-04-01T"+logOutTimeHr+":"+logOutTimeMin+":00");
                                var minutes     = (Math.abs(toTime.getTime() - fromTime.getTime()))/(1000 * 60);
                                var comTTime    = new_user_form[userModeForm].getItemValue("com_total_time"); // company total working time
                                var userTTime   = new_user_form[userModeForm].getItemValue("user_total_time"); // total working time of employee
                                var mGraceTime  = new_user_form[userModeForm].getItemValue("Max_Grace_Time"); // maximum allowed grace time
                                var isGTemp     = new_user_form[userModeForm].getItemValue("US_Grace_Temp_hid"); // existing grace time temp or permanent
                                var isGraceuser = new_user_form[userModeForm].getItemValue("US_Time_Reduced"); // already grace time user
                                //console.log("time in minuutes: ",minutes);
                                var ShowHideGrace = 0;
                                if (isGraceuser == 0 && minutes < comTTime) {
                                    ShowHideGrace = 1;                                    
                                } else if (isGTemp == 0 && minutes < userTTime) {
                                    ShowHideGrace = 1;   
                                } else if (isGraceuser == 1 && minutes != userTTime && minutes < comTTime) {
                                    ShowHideGrace = 1;   
                                }
                                
                                if (ShowHideGrace == 1) {
                                    if ((parseInt(mGraceTime)+parseInt(minutes)) < parseInt(comTTime)) { 
                                        dhtmlx.message({ type: "error", text: "Maximum Allowed Grace Time is "+mGraceTime+" Minuite. If you want more Grace time please contact Top Management." });
                                        return false;
                                    }
                                    //console.log("inside.....",new_user_form[userModeForm].getItemValue("Grace_End_Date"),"---");
                                    new_user_form[userModeForm].showItem('usr_grase_time');
                                    if (new_user_form[userModeForm].getItemValue("Grace_Reason") == "") {
                                        new_user_form[userModeForm].setRequired("Grace_Reason", true);
                                    }
                                    var edndatefield = $('input[name="Grace_End_Date"]').attr('id');
                                    $('label[for="'+edndatefield+'"]').removeClass('redColor'); 

                                    if (new_user_form[userModeForm].getItemValue("US_Grace_Temp") == 0 && new_user_form[userModeForm].getItemValue("Grace_Reason") == "") {
                                        dhtmlx.message({ type: "error", text: "working time is below the company working time. Please fill the Reason." });
                                    }else if (new_user_form[userModeForm].getItemValue("US_Grace_Temp") == 1 && new_user_form[userModeForm].getItemValue("Grace_End_Date") == null) {
                                        $('label[for="'+edndatefield+'"]').addClass('redColor');
                                        dhtmlx.message({ type: "error", text: "working time is below the company working time. Please fill the Reason and Date." });
                                        return false;
                                    }                                                                    
                                } else {
                                    new_user_form[userModeForm].hideItem('usr_grase_time'); 
                            ...
                            //console.log(values.US_Email,"=="+values.US_Password+"---", values.US_ID);
                            if (new_user_form[userModeForm].getItemValue("US_ID") > 0) { //04-12-2024
                                var passvalid = true;
                                var uservalid = true;
                            }else {
                                var uservalid = preTally.Validate.Validate(values, 'US_UName', new_user_form[userModeForm], 'username'); //04-12-2024
                                var passvalid = preTally.Validate.Validate(values, 'US_Password', new_user_form[userModeForm], 'password');//04-12-2024
                            }
                            if (newUserProfile && Cvalidate && uservalid && passvalid && sal_flag !== 1 && Time_err !== 1 && SalErFlag != 1 && SalNullFlag != 1) {
                                preTally.Settings.progressOn(true, dhxLayout, null);
                                new_user_form[userModeForm].send(preTally.Initialize.encryptURL('warehouse/newUser.php&r=' + usId), function (loader, response) {
                                    preTally.Settings.progressOff(true, dhxLayout, null);
                                    if (response != 'fail' && usId != 'self' && viewFlg != 1 && response != 'id_fail' && response != 'usr_fail' && response != 'reporting_fail' && response != 'sal_error') {
                                        new_user_form[userModeForm].resetValidateCss();
                                        new_user_form[userModeForm].clear();
                                        // reset the grace time related settings data 24-07-2025
                                        new_user_form[userModeForm].hideItem('usr_grase_time'); 
                                        new_user_form[userModeForm].setItemValue("com_total_time",comTTime); // company total working time
                                        new_user_form[userModeForm].setItemValue("user_total_time",comTTime); // total working time of employee
                                        new_user_form[userModeForm].setItemValue("Max_Grace_Time",mGraceTime); // maximum allowed grace time
                                        new_user_form[userModeForm].setItemValue("US_Grace_Temp_hid",1); // existing grace time temp or permanent
                                        new_user_form[userModeForm].setItemValue("US_Time_Reduced",0);
                                        //end the grace time settings data 24-07-2025
                                        US_ReportCombo[userModeForm] = new_user_form[userModeForm].getCombo('US_Report');
                                        if (US_ReportCombo[userModeForm]) {
                                        ...
                                        dhtmlx.message('UserId already Exists.Please type another One');
                                    } else if (response == "usr_fail") {
                                        dhtmlx.message('User Name already Exists.Please type another One');
                                    } else {
                                        dhtmlx.message({text: response});
                                    }
                                    if (dhxMiddleBlockTabs.tabs("list_user")) {
                            ...
                            $("#profileImage" + usId).attr("src", "uploads/profileImage/avatar.png");
                            // back up settings fields values for re assign after clear 24-07-2025
                            if (usId != 'self' && viewFlg != 1) {
                                var comTTime    = new_user_form[userModeForm].getItemValue("com_total_time"); // company total working time
                                var userTTime   = new_user_form[userModeForm].getItemValue("user_total_time"); // total working time of employee
                                var mGraceTime  = new_user_form[userModeForm].getItemValue("Max_Grace_Time"); // maximum allowed grace time
                            ...
                            // end before clear grace time section 24-07-2025 
                            new_user_form[userModeForm].resetValidateCss();
                            new_user_form[userModeForm].clear();
                            // reset the grace time related settings data 24-07-2025
                            new_user_form[userModeForm].hideItem('usr_grase_time'); 
...
//          else da=da_per;
        ...
        menuListUser: function () {
            if (!dhxMiddleBlockTabs.cells("list_user")) {
                ...
                listUserStbar = dhxMiddleBlockTabs.cells("list_user").attachStatusBar({
                    text: "<input type='button' value='Export Basic' className= 'button_export' onclick='preTally.UserProfile.exportUsersListReport(0);' style='float:right; background-image: url(images/icon/default_18/excel.png);background-repeat: no-repeat; background-position: 0px 3px ; margin-left:10px; padding-left:25px;height: 25px' /> <input type='button' value='Export' className= 'button_export' onclick='preTally.UserProfile.exportUsersListReport(userIDFilter,nameFilter,AclTypeFilter,DesignationFilter,locationFilter,empstatusFilter,departmentFilter,ApprovedBlockedFilter);' style='float:right; background-image: url(images/icon/default_18/excel.png);background-repeat: no-repeat; background-position: 0px 3px ;padding-left: 22px;height: 25px' />" + "" + tb_data_txt,
                    height: 25
                });
                ...
                listPreTallyUser.loadXML(preTally.Initialize.encryptURL("requisites/listUsers.php&calltype=new"), function () {
                    ...
                    listPreTallyUser.attachEvent("onRowSelect", function (rId, cId) {
                        if (cId === 10) {
                            if (listPreTallyUser.getUserData('', 'acl_status') == 1 && listPreTallyUser.getUserData(rId, 'db_resign_status') != 1) {
        ...
        exportUsersListReport: function (type) {         
            ...
            if (typeof type != "undefined" && type === 0) { // 20-03-25 
                exportfilterValue['isBasic'] = 1; 
            }
        ...
        attendanceSave: function (rowId, cellInd, state, dataDate, dataME) {
            ...
            $.post(
                    ...
                    {dataDate: dataDate, dataME: dataME, userID: userID, state: state, d : RGV2aWNlVW5pcXVlSWQ},
        ...
        markAttendance: function ()
        {
            ...
            setAttForm.loadStruct(preTally.Initialize.encryptURL("requisites/attendForm.php"), function () {
                setAttForm.attachEvent("onButtonClick", function (name) {
                    if (name == "MarkAttend") {
                        setAttForm.send(preTally.Initialize.encryptURL("warehouse/attendance.php")+"&d="+RGV2aWNlVW5pcXVlSWQ, function (loader, response) {
        ...
        listAttendance: function () {
            if (!dhxMiddleBlockTabs.cells("menulistAttendance")) {
                ...
                var ACLMnthlyAttendSummary = unescape(JGG1P3bDnUSDL25Mui7KzYjj30UjPdWxCCtGkJSHeuo);
                var Attenabled = 0;
                var Mnthenabled = 0;
                ...
                if(ACLMnthlyAttendSummary == 1){
                    AttTabbar.addTab("a3", "Monthly Attendance Summary Report");
                    preTally.UserProfile.reportUserAttendanceSummary();
                    Mnthenabled=1;
                    if(Attenabled==0)
                    AttTabbar.tabs("a3").setActive();
                }
                if (ACLPayrollView == 1 || ACLPayrollEdit == 1) {
                    AttTabbar.addTab("a4", "Employee Payroll Manage");
                    Payrollenabled = 1;
                    if(Mnthenabled==0)
                    AttTabbar.tabs("a4").setActive();
                }
                var attFlag = 0;
                var payrollFlag = 0;
                AttTabbar.attachEvent("onSelect", function (id, last_id) {
                    ...
                    if (id == "a4" && payrollFlag == 0 && Payrollenabled == 1) {
        ...
        listUserAttendance: function ()
        {
            ...
            $(".refreshAttTab").unbind("click").click(function () {
                ...
                AttendGrid.loadXML(preTally.Initialize.encryptURL("requisites/listAttendanceUsers.php&" + params), function () {
                    ...
                    $('.att_incmhour').html("Hour Incomplte : " + AttendGrid.getUserData("", "att_incmhour") + " ");
                    $('.att_incmhour').attr("count", AttendGrid.getUserData("", "att_incmhour")); 
            ...
            var tb_data_txt = ' <div class="att_data_txt_secl">\
                                        ...
                                        <div class="att_footer_click att_rpt_signout" count="0" filt="0" style="width:420px;text-align: center;" srt="Sign Out">Sign Out : 0</div>\
                                        </div>\
                                    <div class="att_data_txt_secl" style="top:30px;">\
                                        ...
                                        <div class="att_footer_click att_incmhour" count="0" filt="0" style="width:105px;" srt="Hour Incomplte">Hour Incomplte: 0</div>\
                                    </div>';
...
//                         ApproveLeaveGrid.clearAndLoad(preTally.Initialize.encryptURL("requisites/listApproveLeave.php"), function() {});
        ...
        applyRptAttFilter: function () {
            ...
            AttReportsGrid.setColLabel(1, '<div id="attRptEmpFiltr" class="mnthemp_filter" style="width: 90%;"><img src="images/icon/sort-' + col1img + '-icon.png" title="Click here to Sort" colNum="1" class="btn_MnthlyAttSort" style="float:right;" /></div>');//08-04-25
            ...
            AttEmpFltrcbo = new dhtmlXCombo("attRptEmpFiltr", "FltEmpCbo", "100%", "checkbox"); //08-04-25
            AttFiltrcombo.setOptionWidth(150);
            AttEmpFltrcbo.setOptionWidth(200); //08-04-25
            ...
            //08-04-25 Start
            var selEmpflt = '&type=clear';//'&type=filt'; 
            if(chkempFltr) {
                selEmpflt += '&userides='+chkempFltr;
            }
            AttEmpFltrcbo.load(preTally.Initialize.encryptURL("requisites/usersChkCbo.php" + selEmpflt)); 
            AttEmpFltrcbo.enableFilteringMode(true); 
            AttEmpFltrcbo.attachEvent("onCheck", function(value, state){
                /*if (value == 0) {
                   chkempFltr = []; 
                }else if (state == true) {
                    chkempFltr.push(value);                    
                } else {
                    let inddet = chkempFltr.indexOf(value);
                    chkempFltr.splice(inddet, 1);
                } 
                filtrInterval = setInterval(function () {
                    //console.log(AttEmpFltrcbo.getChecked());
                    preTally.UserProfile.applyAttFilter(1, 'asc');                    
                    clearInterval(filtrInterval);
                }, 500);
                if (value == 0) {
                    AttEmpFltrcbo.unSelectOption();
                    AttEmpFltrcbo.closeAll();
                    return false;
                }*/
                //21-04-2025 changed functions....                        
                var seltindx = AttEmpFltrcbo.getIndexByValue(value);
                if (CoMboOpen == 1) { //29-07-2025
                    if (value == 0) {
                        chkempFltr = []; 
                        AttEmpFltrcbo.unSelectOption();
                        AttEmpFltrcbo.closeAll();
                    }else {
                        if(AttEmpFltrcbo.isChecked(seltindx)) {
                            AttEmpFltrcbo.setChecked(seltindx, false);
                            let inddet = chkempFltr.indexOf(value);
                            chkempFltr.splice(inddet, 1);
                        } else {
                            AttEmpFltrcbo.setChecked(seltindx, true);
                            chkempFltr.push(value);
                        }
                        AttEmpFltrcbo.closeAll();
                    }
            ...
            AttEmpFltrcbo.attachEvent("onChange", function(value, text) {                            
                var seltindx = AttEmpFltrcbo.getSelectedIndex(); 
                if (CoMboOpen == 1) { //29-07-2025            
                    if (seltindx == 0) {
                        chkempFltr = []; 
                        AttEmpFltrcbo.unSelectOption();
                        AttEmpFltrcbo.closeAll();
                    }else if(seltindx > 0 && AttEmpFltrcbo.isChecked(seltindx)) {
                        AttEmpFltrcbo.setChecked(seltindx, false);
                        let inddet = chkempFltr.indexOf(value);
                        chkempFltr.splice(inddet, 1);
                    } else if(seltindx > 0) {
            ...
            //end 09-04-2025
            AttEmpFltrcbo.attachEvent("onOpen", function() {
                CoMboOpen = 1;
            });
            // end 29-07-2025
        ...
        applyRptAttFilterSummary: function () {
            var filtrInterval;
            col1img = 'ascending';
            if (attSortdRow == 1 && attsrtFlg == 0)
                col1img = 'ascending';
            ...
            if (attSortdRow == 2 && attsrtFlg == 0)
                ...
                col2img = 'descending';
            // //AttReportsGridSummary.setColLabel(1, '<input id="attRptNameFiltr" class="mnthatt_txt_filter" type="text" placeholder="Enter a name  to search . . ." style="width: 80%;"><img src="images/icon/sort-' + col1img + '-icon.png" title="Click here to Sort" colNum="1" class="btn_MnthlyAttSort" />');
            AttReportsGridSummary.setColLabel(1, '<div id="attRptEmpFiltrSummary" class="mnthemp_filter_summary" style="width: 95%;"><img src="images/icon/sort-' + col1img + '-icon.png" title="Click here to Sort" colNum="1" class="btn_MnthlyAttSortSummary" style="float:right;" /></div>');//08-04-25
            AttReportsGridSummary.setColLabel(2, '<div id="attRptBranchFiltrSummary" class="mnthatt_filter_summary" style="width: 95%;"><img src="images/icon/sort-' + col2img + '-icon.png" title="Click here to Sort" colNum="2" class="btn_MnthlyAttSortSummary" style="float:right;" /></div>');
            AttFiltrcomboSummary = new dhtmlXCombo("attRptBranchFiltrSummary", "FiltComboSummary", "85%");
            AttEmpFltrcboSummary = new dhtmlXCombo("attRptEmpFiltrSummary", "FltEmpCboSummary", "85%", "checkbox"); //08-04-25
            AttFiltrcomboSummary.setOptionWidth(150);
            AttEmpFltrcboSummary.setOptionWidth(200); //08-04-25

            var selectedLocation = '&filter=all&seltdQffz=0';
            if (ofceFilter)
                selectedLocation = '&filter=all&seltdQffz=' + ofceFilter;
            AttFiltrcomboSummary.load(preTally.Initialize.encryptURL("requisites/locations.php" + selectedLocation));
            AttFiltrcomboSummary.setFilterHandler(function (mask, option) {
                var r = false;
                if (mask.length == 0) {
                    r = true;
                } else if (option.text.match(new RegExp("^" + mask, "i")) != null) {
            ...
            AttFiltrcomboSummary.attachEvent("onChange", function () { // Filter for Office Location Change
                preTally.UserProfile.applyAttFilterSummary(2, 'asc');
            });
            //08-04-25 Start
            var selEmpflt = '&type=clear';//'&type=filt'; 
            if(chkempFltrSummary) {
                selEmpflt += '&userides='+chkempFltrSummary;
            }
            //console.log(chkempFltrSummary);
            AttEmpFltrcboSummary.load(preTally.Initialize.encryptURL("requisites/usersChkCbo.php" + selEmpflt)); 
            AttEmpFltrcboSummary.enableFilteringMode(true); 
            AttEmpFltrcboSummary.attachEvent("onCheck", function(value, state){
                //21-04-2025 changed functions....
                var seltindx = AttEmpFltrcbo.getIndexByValue(value);
                if (value == 0) {
                    chkempFltrSummary = []; 
                    AttEmpFltrcboSummary.unSelectOption();
                    AttEmpFltrcboSummary.closeAll();
                }else {
                    if(AttEmpFltrcboSummary.isChecked(seltindx)) {
                        AttEmpFltrcboSummary.setChecked(seltindx, false);
                        let inddet = chkempFltrSummary.indexOf(value);
                        chkempFltrSummary.splice(inddet, 1);
                    } else {
                        AttEmpFltrcboSummary.setChecked(seltindx, true);
                        chkempFltrSummary.push(value);
                    }
                    AttEmpFltrcboSummary.closeAll();
                }
                preTally.UserProfile.applyAttFilterSummary(1, 'asc'); 
                return false;
            });
            AttEmpFltrcboSummary.attachEvent("onChange", function(value, text){
                var seltindx = AttEmpFltrcboSummary.getSelectedIndex();                
                if (value == 0) {
                    chkempFltrSummary = []; 
                    AttEmpFltrcboSummary.unSelectOption();
                    AttEmpFltrcboSummary.closeAll();
                }else if(AttEmpFltrcboSummary.isChecked(seltindx)) {
                    AttEmpFltrcboSummary.setChecked(seltindx, false);
                    let inddet = chkempFltrSummary.indexOf(value);
                    chkempFltrSummary.splice(inddet, 1);
                } else {
            ...
            $(".btn_MnthlyAttSortSummary").click(function () {
                var ColNum = $(this).attr("colNum");
                attSortdRow = ColNum;
                var colimg;
                if (attsrtFlg == 0) {
                ...
                preTally.UserProfile.applyAttFilterSummary(ColNum, attord);
            });
            $(".mnthatt_txt_filter_summary").keyup(function () {
                if (filtrInterval)
                    clearInterval(filtrInterval);
                filtrInterval = setInterval(function () {
                    preTally.UserProfile.applyAttFilterSummary(2, 'asc');
        ...
        reportUserAttendance: function ()
        {
            ...
            RptAttendanceToolbar.addButton("attenExports", '3', 'Export Attendance', 'excel.png');
            RptAttendanceToolbar.addText("spacer", '2', "");
            RptAttendanceToolbar.disableItem("spacer");
            RptAttendanceToolbar.setWidth("spacer", 100);
            RptAttendanceToolbar.addButton("payrollReport", '4', 'Generate Payroll Report', 'other.gif');
            RptAttendanceToolbar.attachEvent("onClick", function (id) {
                ...
                if (pId == 'att_month_filter') {
                    ...
                    if (mnthlyatt_sel_month > Date.today().getMonth() + 1 && mnthlyatt_sel_year == Date.today().getFullYear())
                    {
                        ...
                        // hide below for remove paginations @ 22-aug-2024
                        ...
                        AttReportsGrid.attachEvent("onXLE", function () {
                            ...
                            preTally.UserProfile.reportUserAttendanceFunction(true, mnthlyatt_sel_year, mnthlyatt_sel_month);
                            if (nameFilter != '')
                                $('#attRptNameFiltr').val(nameFilter);
                        });
                        AttReportsGrid.init();
                        ofceFilter = 0;
                        chkempFltr = []; //08-04-2025
                        var params = "att_month=" + mnthlyatt_sel_month + "&att_year=" + mnthlyatt_sel_year + "&display_type=list";
                ...
                if (id == "payrollReport") {
                    var params = "att_month=" + mnthlyatt_sel_month + "&att_year=" + mnthlyatt_sel_year;
                    $.post(preTally.Initialize.encryptURL("warehouse/generatePayrollReport1.php&" + params), function (data, status) {
                ...
                if (id == "attenExports") { // 10-04-2025
                    //var filenams = parseInt(prev_month)+"-"+prev_year+".csv";  // 23-06-2025
                    let monthName = new Date(0, prev_month - 1).toLocaleString('default', { month: 'long' }); // 23-06-2025 by Achu
                    var filenams = 'Monthly attendance report for '+monthName+" "+prev_year+".csv";
                    var linkadwn = document.createElement("a");
                    linkadwn.setAttribute('download', filenams);
                    linkadwn.href = remote_path+"uploads/attendance/"+filenams;
                    document.body.appendChild(linkadwn);
                    linkadwn.click();
                    linkadwn.remove();
                }
            });
            ...
            RptAttendanceLayout.cells("a").attachStatusBar({
                text: "<div class='tb_data_txt_secl'>\
                                <div style='float:left;font-weight:bold;padding-left:12px;font-size:12px;'><font color='green'>P-Present</font>&nbsp;&nbsp;<font color='orange'>P2-Halfday</font>&nbsp;&nbsp;<font color='green'>HI-Hours Incomplete</font>&nbsp;&nbsp;<font color='#0000ff'>C-Compensatory</font>&nbsp;&nbsp;<font color='orange'>2HI-Halfday Incomplete</font>&nbsp;&nbsp;<font color='#8258FA'>H-Holiday</font>&nbsp;&nbsp;<font color='#8258FA'>W-Weekend off</font>&nbsp;&nbsp;<font color='#8258FA'>S-Sunday off</font>&nbsp;&nbsp;<font color='red'>L-Leave</font>&nbsp;&nbsp;<font color='red'>SDL-Salary Deductable Leave</font>&nbsp;&nbsp;<font color='black'>ES-Early Signout</font>&nbsp;&nbsp;<font color='black'>LS-late Signin</font></div>\
            ...
            AttReportsGrid.enableRowsHover(true, "hover"); // hover color rows
            AttReportsGrid.init();
            nameFilter = '';
            ofceFilter = '';
            chkempFltr = []; //08-04-2025
            ...
            // First Time Loads            
            var params = "display_type=list";
            AttReportsGrid.load(preTally.Initialize.encryptURL("requisites/listRptAttendance.php&" + params), function () {
                 AttReportsGrid.splitAt(3);
        ...
        reportUserAttendanceSummary: function ()
        {
            var Months_Options = [];
            var Year_Options = [];
            var mnthLimit;
            ...
            var month = Date.today().getMonth();
            mnthlyatt_sel_month_summary = month + 1;
            mnthlyatt_sel_year_summary = Date.today().getFullYear();
            RptAttendanceLayoutSummary = AttTabbar.tabs("a3").attachLayout('1C');
            RptAttendanceToolbarSummary = RptAttendanceLayoutSummary.cells("a").attachToolbar();
            RptAttendanceLayoutSummary.cells("a").hideHeader();
            RptAttendanceToolbarSummary.setIconsPath("images/icon/default_18/");
            RptAttendanceToolbarSummary.addButtonSelect("att_month_filter_summary", '1', "Select Month", Months_Options, 'calendar_M.png', '', true, true, 10, 'select');
            RptAttendanceToolbarSummary.addButtonSelect("att_year_filter_summary", '2', "Select Year", Year_Options, 'calendar_Y.png', '', true, true, 10, 'select');
            RptAttendanceToolbarSummary.setItemText('att_month_filter_summary', monthNames[Date.today().getMonth()]);
            RptAttendanceToolbarSummary.setItemText('att_year_filter_summary', Date.today().getFullYear());
            
            RptAttendanceToolbarSummary.addButton("attenExports", '3', 'Export Attendance', 'excel.png');
            RptAttendanceToolbarSummary.addText("spacer", '2', "");
            RptAttendanceToolbarSummary.disableItem("spacer");
            RptAttendanceToolbarSummary.setWidth("spacer", 100);
            RptAttendanceToolbarSummary.attachEvent("onClick", function (id) {
                currentDate = new Date();
                var prev_month = mnthlyatt_sel_month_summary;
                var prev_year = mnthlyatt_sel_year_summary;
                var pId = RptAttendanceToolbarSummary.getParentId(id);
                if (pId == 'att_month_filter_summary') {
                    nameFilter = "";
                    mnthlyatt_sel_month_summary = id.substr(1);
                    if (RptAttendanceToolbarSummary.getListOptionSelected("att_year_filter_summary")) {
                        mnthlyatt_sel_year_summary = RptAttendanceToolbarSummary.getListOptionSelected("att_year_filter_summary");
                        mnthlyatt_sel_year_summary = mnthlyatt_sel_year_summary.substr(1);
                    }
                    var params = "att_month=" + mnthlyatt_sel_month_summary + "&att_year=" + mnthlyatt_sel_year_summary;
                    if (mnthlyatt_sel_month_summary > Date.today().getMonth() + 1 && mnthlyatt_sel_year_summary == Date.today().getFullYear())
                    {
                        dhtmlx.message("Cant go above Current Month");
                        var CellDate = AttReportsGridSummary.getUserData("", "cellDate");
                        var mntArr = CellDate.split("-");
                        RptAttendanceToolbarSummary.setListOptionSelected('att_month_filter_summary', mntArr[1]);
                        RptAttendanceToolbarSummary.setItemText('att_month_filter_summary', monthNames[mntArr[1] - 1]);
                        RptAttendanceToolbarSummary.setListOptionSelected('att_year_filter_summary', mntArr[0]);
                        RptAttendanceToolbarSummary.setItemText('att_year_filter_summary', mntArr[0]);
                        mnthlyatt_sel_month_summary = mntArr[1];
                        mnthlyatt_sel_year_summary = mntArr[0];
                    } else {
                        AttReportsGridSummary.destructor();
                        AttReportsGridSummary = RptAttendanceLayoutSummary.cells("a").attachGrid();
                        AttReportsGridSummary.enableColSpan(true);
                        // hide below for remove paginations @ 22-aug-2024
                        //AttReportsGridSummary.setPagingWTMode(true, false, true, [15, 30, 50, 80]);
                        //AttReportsGridSummary.enablePaging(true, 50, 5, "pagingbox", true);
                        //AttReportsGridSummary.setPagingSkin("toolbar", "dhx_skyblue");
                        AttReportsGridSummary.setImagePath("assets/grid/codebase/imgs/");
                        AttReportsGridSummary.attachEvent("onXLS", function () {
                            preTally.Settings.progressOn(true, dhxLayout, null);
                            //console.log('Call Requested');
                        });
                        AttReportsGridSummary.attachEvent("onXLE", function () {
                            preTally.Settings.progressOff(true, dhxLayout, null);
                            //console.log('Call Completed');
                            preTally.UserProfile.reportUserAttendanceFunctionSummary(true);
                            if (nameFilter != '')
                                $('#attRptNameFiltr').val(nameFilter);
                        });
                        AttReportsGridSummary.init();
                        ofceFilter = 0;
                        chkempFltrSummary = []; //08-04-2025
                        var params = "att_month=" + mnthlyatt_sel_month_summary + "&att_year=" + mnthlyatt_sel_year_summary + "&display_type=summary";
                        AttReportsGridSummary.clearAndLoad(preTally.Initialize.encryptURL("requisites/listRptAttendance.php&" + params), function () {
                            // AttReportsGridSummary.splitAt(6);
                            preTally.UserProfile.reportUserAttendanceFunctionSummary(true);
                        }, "json");
                    }

                }
                if (pId == 'att_year_filter_summary') {
                    nameFilter = "";
                    mnthlyatt_sel_year_summary = id.substr(1);
                    if (RptAttendanceToolbarSummary.getListOptionSelected("att_month_filter_summary")) {
                        mnthlyatt_sel_month_summary = RptAttendanceToolbarSummary.getListOptionSelected("att_month_filter_summary");
                        mnthlyatt_sel_month_summary = mnthlyatt_sel_month_summary.substr(1);
                    }
                    //var params  = "att_month=" + mnthlyatt_sel_month + "&att_year="+mnthlyatt_sel_year ;                    
                    if (mnthlyatt_sel_month_summary > Date.today().getMonth() + 1 && mnthlyatt_sel_year_summary == Date.today().getFullYear())
                    {
                ...
                if (id == "payrollReport") {
                    ...
                    $.post(preTally.Initialize.encryptURL("warehouse/generatePayrollReport1.php&" + params), function (data, status) {
                        ...
                        if (data == "1") {
                            AttReportsGridSummary.enableEditEvents(false, false, false);
                            attFlag = 2;
                            dhtmlx.message({text: "Payroll Successfully Generated"});
                        } else if (data == "2") {
                            dhtmlx.message({text: "Payroll already exist"});
                ...
                if (id == "attenExports") { // 10-04-2025
                    //var filenams = parseInt(prev_month)+"-"+prev_year+".csv";  // 23-06-2025
                    let monthName = new Date(0, prev_month - 1).toLocaleString('default', { month: 'long' }); // 23-06-2025 by Achu
                    var filenams = 'Monthly attendance summary report for '+monthName+" "+prev_year+".csv";
                    var linkadwn = document.createElement("a");
                    linkadwn.setAttribute('download', filenams);
                    linkadwn.href = remote_path+"uploads/attendance/summary/"+filenams;
                    document.body.appendChild(linkadwn);
                    linkadwn.click();
                    linkadwn.remove();
                }
            ...
            AttReportsGridSummary.enableColSpan(true);
            AttReportsGridSummary.setImagePath("assets/grid/codebase/imgs/");
            // AttReportsGridSummary.splitAt(1);
            /*AttReportsGridSummary.attachEvent("onFilterEnd", function(elements){
             if(AttReportsGridSummary.getRowsNum() == 0 ){
             AttReportsGridSummary.addRow("no_records",['No Records Found...'],1); 
             AttReportsGridSummary.setColspan("no_records",0,2);  
             AttReportsGridSummary.setRowTextStyle("no_records", "font-size:14px;color:#0979B1;text-align:center !important;font-family: serif;padding-top: 5px;");
             }else{
             AttReportsGridSummary.deleteRow(0);
             }                         
             }); */
            ...
            RptAttendanceLayoutSummary.cells("a").attachStatusBar({
                text: "<div class='tb_data_txt_secl'>\
                                <div style='float:left;font-weight:bold;padding-left:12px;font-size:12px;'><font classs='red'>CL-Casual Leave</font> | <font color='red'>SL-Sick Leave</font> | <font color='green'>EL-Earned Leave</font> | <font color='#0000ff'>CW-Compensatory Working</font> | <font color='#0000ff'>CWP-Previous Month Compensatory Working</font> | <font color='red'>SDL-Salary Deductable Leave</font></div>\
                            </div><div style='float:right;' id='pagingbox'></div>", // status bar text
                height: 35                              // custom height
            });
            // hide below for remove paginations @ 22-aug-2024
            ...
            //AttReportsGridSummary.enablePaging(true, 50, 5, "pagingbox", true);
            //AttReportsGridSummary.setPagingSkin("toolbar", "dhx_skyblue");
            AttReportsGridSummary.enableTooltips("false,false,false,false,false,false,false,false, false,false,false,false,false,false,false");
            AttReportsGridSummary.enableRowsHover(true, "hover"); // hover color rows
            // AttReportsGridSummary.setInitWidths("40,10,100,100,100,20,10,70,50, 30,30, 30,30, 30,30, 30,30");
            AttReportsGridSummary.init();            

            nameFilter = '';
            ofceFilter = '';
            chkempFltrSummary = []; //08-04-2025
            //AttReportsGridSummary.loadXML(preTally.Initialize.encryptURL("requisites/listRptAttendance.php"),function(){  
            // First Time Loads     
            var params = "&display_type=summary";       
            AttReportsGridSummary.load(preTally.Initialize.encryptURL("requisites/listRptAttendance.php&" + params), function () {
                // AttReportsGridSummary.splitAt(3);
                //console.log('Call Initiated');
                preTally.UserProfile.reportUserAttendanceFunctionSummary(true);
                // setTimeout(function () {alert(1);
                //     AttReportsGridSummary.setColumnMinWidth("40,100,100,100,100,20,10,70,50, 30,30, 30,30, 30,30, 30,30");
                // }, 2000);
            }, "json");
            //preTally.Settings.progressOff(true, dhxLayout, null);

            document.addEventListener('mouseover', function(e) {
                if (e.target && e.target.classList.contains('tooltipHead')) {
                    preTally.Settings.showLabel(e.target, e.target.getAttribute('data-title'));
                }
            });

            document.addEventListener('mouseout', function(e) {
                if (e.target && e.target.classList.contains('tooltipHead')) {
                    preTally.Settings.hideLabel(e.target);
                }
            });
        ...
        applyAttFilter: function (sortFilter, ord) {// Change Office
            ...
            //chkempFltr = AttEmpFltrcbo.getChecked();  //08-04-2025   
            var empids      = "&emp_ids="+chkempFltr; //09-04-2025  
            var filterValue = new Array(nameFilter, ofceFilter, sortFilter, ord);
            var filtr = params + "&Filters=" + filterValue + "&calltype=upd"+empids + "&display_type=list";
            AttReportsGrid.enableTooltips("false,false,false,false,false,false,false,true");
        ...
        applyAttFilterSummary: function (sortFilter, ord) {// Change Office

            var params = '';
            /*var filterMonth = RptAttendanceToolbar.getListOptionSelected('att_month_filter');     
             if(filterMonth)*/ params = "att_month=" + mnthlyatt_sel_month_summary + "&att_year=" + mnthlyatt_sel_year_summary;
            nameFilter = '';//$('#attRptNameFiltr').val();
            ofceFilter = AttFiltrcomboSummary.getSelectedValue();
            //chkempFltrSummary = AttEmpFltrcbo.getChecked();  //08-04-2025   
            var empids      = "&emp_ids="+chkempFltrSummary; //09-04-2025  
            var filterValue = new Array(nameFilter, ofceFilter, sortFilter, ord);
            var filtr = params + "&Filters=" + filterValue + "&calltype=upd"+empids + "&display_type=summary";
            AttReportsGridSummary.enableTooltips("false,false,false,false,false,false,false,true");
            AttReportsGridSummary.clearAndLoad(preTally.Initialize.encryptURL("requisites/listRptAttendance.php&" + filtr), function () {
                //AttReportsGridSummary.splitAt(3);   
                //preTally.UserProfile.reportUserAttendanceFunctionSummary(false);                
                //AttReportsGridSummary.setColSpan("null_row",1,10) ;
                if (AttReportsGridSummary.getRowsNum() == 0) {
                    AttReportsGridSummary.addRow("null_row", '<div style="font-size:16px;font-variant:small-caps;color:#0979B1;text-align:center !important;font-family: serif;padding-top: 10px;" >No records found</div>');
                    var colNum = AttReportsGridSummary.getColumnsNum();
                    AttReportsGridSummary.setColspan("null_row", 0, colNum);
                    AttReportsGridSummary.setRowExcellType("null_row", "ro");
                }
                //$('#attRptNameFiltr').focus();                            
                //$('#attRptNameFiltr').focus().val('').val(nameFilter);
            }, "json");
        },
        reportUserAttendanceFunction: function (drawFilter, year, month) {
            // console.log(year+"=>"+month);
            var newTimeCheckRuleHIColor = preTally.UserProfile.attendaceDateLimitForNewFunction(year, month);
            currentDate = new Date();
            ...
            AttReportsGrid.forEachRow(function (id) {
                ...
                for (var m = 3; m <= (parseInt(totalDays) + 3); m++) {
                    ...
                    if (cellValue == 'P') {
                        cellColor = 'green';
                    } else if (cellValue == 'HI') {
                        cellColor = newTimeCheckRuleHIColor;
                    } else if (cellValue == '2HI') {
                        cellColor = 'orange';
                    } else if (cellValue == 'C') {
                        cellColor = '#0000ff';
                    } else if (cellValue == 'LC') {
                        cellColor = 'red';
                    } else if (cellValue == 'C2') {
                        cellColor = '#0000ff';
                ...
                for (var m = parseInt(leaveCount); m >= 0; m--) {
                    AttReportsGrid.setCellTextStyle(id,(columnCount - (m+6)),"color:black;");
                }
                // console.log("total column" + columnCount);
                // console.log("leave count" + parseInt(leaveCount));
                // console.log(columnCount - (parseInt(leaveCount)));
                ...
                // AttReportsGrid.setCellTextStyle(id, (columnCount - 13), "color:blue;"); //sdl
                AttReportsGrid.setCellTextStyle(id, (columnCount - 8), "color:red;"); //sdl
                AttReportsGrid.setCellTextStyle(id, (columnCount - 7), "color:red;"); //HI
                AttReportsGrid.setCellTextStyle(id, (columnCount - 6), "color:black;"); //ls
                AttReportsGrid.setCellTextStyle(id, (columnCount - 5), "color:black;");//es
                AttReportsGrid.setCellTextStyle(id, (columnCount - 4), "color:black;");//gs
                AttReportsGrid.setCellTextStyle(id, (columnCount - 3), "color:black;");//ns
                // console.log("display count => " + columnCount - (parseInt(leaveCount)+8));
                AttReportsGrid.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+11)), "color:red;");//TL
                AttReportsGrid.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+12)), "color:orange;");//HD
                AttReportsGrid.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+13)), "color:green;");//FD
            });
        },
        attendaceDateLimitForNewFunction: function(year, month) {
            ...
            if (parseInt(year) === currentYear && parseInt(month) === currentMonth) {
                // If it's the current month, use yesterday
                targetDate = new Date(today);
                targetDate.setDate(today.getDate() - 1);
            } else {
                // Else, use last day of the given month
                targetDate = new Date(year, month, 0); // 0 gives the last day of previous month
            }

            // Format as YYYYMMDD
            const formattedDate = targetDate.toISOString().slice(0, 10).replace(/-/g, '');

            const newTimeCheckRuleStarts = (20250601 <= parseInt(formattedDate)) ? 1 : 0;

            //console.log('Check Flag:', newTimeCheckRuleStarts, '| Date Used:', formattedDate);
            changedAttributes = 'green';
            if(newTimeCheckRuleStarts===1){
                changedAttributes = 'red';
            }
            //console.log(changedAttributes);
            return changedAttributes;
        },
        reportUserAttendanceFunctionSummary: function (drawFilter) {
            currentDate = new Date();
            /*var nowMonth ; var nowYear ;
             if(!isNaN(month)){                
             nowMonth =month; 
            ...
            if (drawFilter == true) {
                preTally.UserProfile.applyRptAttFilterSummary();
                preTally.UserProfile.intializeRptAttEdit();
            }

            var columnCount = AttReportsGridSummary.getColumnsNum();
            var leaveCount = AttReportsGridSummary.getUserData("", "leaveCount");
            var totalDays = AttReportsGridSummary.getUserData("", "totalDays");
            AttReportsGridSummary.forEachRow(function (id) {
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - 7), "color:red;"); //HI
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - 6), "color:black;"); //ls
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - 5), "color:black;");//es
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - 4), "color:red;");//sdl
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - 3), "color:black;");//ns
                // console.log("display count => " + columnCount - (parseInt(leaveCount)+8));
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+8)), "color:red;");//TL
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+9)), "color:orange;");//HD
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+10)), "color:green;");//FD
                AttReportsGridSummary.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+11)), "color:black;");//TWD
            });
        },
        reportShowAttendance: function (id) {
            var selectedUserId = id;
            var userAttendanceWin = new dhtmlXWindows();
            var userAttWin = userAttendanceWin.createWindow("Attendance", 600, 200, 900, 550);
            ...
            myuserattToolBar.attachEvent("onClick", function (id) {
                ...
                if (pId == 'att_month_filter') {
                    ...
                    userAttGrid.loadXML(preTally.Initialize.encryptURL("requisites/listUsersAttendance.php&" + params), function () {
                        ...
                        preTally.UserProfile.userAttGridFilter(); //1-oct-2024
                    });
                }
                if (pId == 'att_year_filter') {
            ...
            userAttGrid.enableRowsHover(true, "hover");  
        ...
        userAttGridFilter: function() { // new filter added by Bilin @ 1-oct-2024
            userAttGrid.makeFilter("AT_label", 6);
            userAttGrid.getFilterElement(6)._filter = function(){
                var input = this.value; // gets the text of the filter input
                if (!input) return;

                return function(value, id) {
                    var mcal = userAttGrid.getUserData(id, "hourlabel");
                    var val = "TTT";
                    if (input.toLowerCase() == "hours incomplete") {
                        val = "IH";
                    } else if (input.toLowerCase() == "late sign in") {
                        val = "LS";
                    } else if (input.toLowerCase() == "hours incomplete") {
                        val = "ES";
                    }
                    if (value.toLowerCase() == input.toLowerCase() || mcal.indexOf(val)!==-1) { 
                        return true;
                    }
                    return false;
                }
...
//                else if(cellValue == 'LP2') newTitle = '';
            ...
            if (unescape(JGG1P3bDnUSDL15Mui7KzYjj28UjPdWxCCtGkJSHeuo) == 1 || unescape(JGG1P3bDnUSDL16Mui7KzYjj28UjPdWxCCtGkJSHeuo) == 1)
                PayrollBtn = 1;
            //if (ACLedit == 0) // generate payroll Report button for attendance edit  or payroll edit acl users 04-02-2025
            if (ACLedit == 0 && unescape(JGG1P3bDnUSDL16Mui7KzYjj28UjPdWxCCtGkJSHeuo) == 0)
            ...
            onEditCellAttendance = AttReportsGrid.attachEvent("onEditCell", function (stage, rId, cInd, nValue, oValue) {
                ...
                if (stage == 0) {
                    ...
                    $.post(preTally.Initialize.encryptURL("warehouse/updateAttReport.php" + filterData), function (data, status) {
                        ...
                        var chkempFltr = AttEmpFltrcbo.getChecked(); //08-04-2025
                        ...
                        window.dhx4.ajax.post(preTally.Initialize.encryptURL("requisites/listRptAttendance.php&" + filtr + "&calltype=upd&userFilter=" + usid), function (data, status) {
                            ...
                            // new loop 24-sep-2024
                            for (var j = 3; j < (columnCount-1); j++) {
                                var cellValue = responseArray[(j+1)].replace(/"/g, "");
                                var cellColor = 'red';
                                if (cellValue == 'P') {
                                    cellColor = 'green';
                                } else if (cellValue == '2HI') {
                                ...
                                AttReportsGrid.cellById(rId, j).setTextColor(cellColor);
                                AttReportsGrid.cellById(rId, j).setValue(cellValue);
                            }
                            /*for (var j = 0; j < (columnCount - 3); j++) {                           
                                var cellValue = responseArray[(j + 4)].replace(/"/g, "");
                                var cellColor = 'black';
                                if (cellValue == 'P') {
                                    cellColor = 'green';
                                } else if (cellValue == '2HI') {
                            ...
                            //AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount) + 5)), "color:black;");
                            ...
                            for (var m = parseInt(leaveCount); m >= 0; m--) {
                                AttReportsGrid.setCellTextStyle(rId,(columnCount - (m+6)),"color:black;");
                            }
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 7), "color:red;");
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 6), "color:black;");
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 5), "color:black;");
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 4), "color:red;");
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 3), "color:black;");//gs
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 2), "color:black;");//ns
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+8)), "color:red;");//TL
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+9)), "color:orange;");//HD
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+10)), "color:green;");//FD        


                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 8), "color:red;"); //sdl
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 7), "color:black;"); //ls
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 6), "color:black;"); //es
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 5), "color:red;");//HI
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 4), "color:black;");//gs
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - 3), "color:black;");//ns
                            // // console.log("display count => " + columnCount - (parseInt(leaveCount)+8));
                            // AttReportsGrid.setCellTextStyle(id, (columnCount - (parseInt(leaveCount)+11)), "color:red;");//TL
                            ...
                            // AttReportsGrid.setCellTextStyle(rId, (columnCount - 14), "color:red;"); //sdl
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 8), "color:red;"); //sdl
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 7), "color:red;"); //HI
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 6), "color:black;"); //ls
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 5), "color:black;");//es
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 4), "color:black;");//gs
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 3), "color:black;");//gs
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - 2), "color:black;");//ns
                            // console.log("display count => " + columnCount - (parseInt(leaveCount)+8));
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+11)), "color:red;");//TL
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+12)), "color:orange;");//HD
                            AttReportsGrid.setCellTextStyle(rId, (columnCount - (parseInt(leaveCount)+13)), "color:green;");//FD
        ...
        ListEmpPayroll: function () {
            var ACLPayrollEdit = unescape(JGG1P3bDnUSDL16Mui7KzYjj28UjPdWxCCtGkJSHeuo);
            empPayrollLayout = AttTabbar.tabs("a4").attachLayout('1C');
...
//                    preTally.UserProfile.getSalRptFooter(params);
        ...
        editLateEntry: function (element, recordData) {
            preTally.UserProfile.applyLateEntry(recordData); // Pass data to form
        },
        applyLateEntry: function (recordData = null) {
            var dhxApplyLateEntryWin = new dhtmlXWindows();
            var applyLateEntryWin = dhxApplyLateEntryWin.createWindow("applyLateEntry", 500, 150, 400, 380);
            ...
            applyLateEntryForm.loadStruct(preTally.Initialize.encryptURL("requisites/applyForLateEntry.php"), function () {
                ...
                applyLateEntryForm.attachEvent("onChange", function (name) {
                    if (name == "Att_Lt_From_Date")
                    {
                        applyLateEntryForm.setItemValue("Att_Lt_To_Date", "");
                        applyLateEntryForm.setItemValue("Att_Lt_NumOFDays", "1.0");
                ...
                $('input[name="late_hr_new_value"]').each(function() {
                    $(this).closest('.dhxcombo_dhx_skyblue').css('width', '100%');
                });

                $('input[name="late_min_new_value"]').each(function() {
                    $(this).closest('.dhxcombo_dhx_skyblue').css('width', '100%');
                });

                $('.dhxform_note').each(function() {
                    $(this).css('width', '100%');
                });
                ...
                // alert(recordData);
                if (recordData !== null) {
                    var duration = recordData.Att_Lt_Duration;

                    var durationParts = duration.split(":");
                    var hours = durationParts[0] || "0";
                    var minutes = durationParts[1] || "0";

                    applyLateEntryForm.setItemValue("Att_Lt_Id", recordData.Att_Lt_Id);
                    applyLateEntryForm.setItemValue("Att_Lt_From_Date", new Date(recordData.Att_Lt_From_Date));
                    applyLateEntryForm.setItemValue("Att_Lt_To_Date", new Date(recordData.Att_Lt_To_Date));
                    // applyLateEntryForm.setItemValue("Att_Lt_Duration", recordData.Att_Lt_Duration);
                    applyLateEntryForm.setItemValue("late_hr", hours);
                    applyLateEntryForm.setItemValue("late_min", minutes);
                    applyLateEntryForm.setItemValue("Att_Lt_NumOFDays", recordData.Att_Lt_NumOFDays);
                    applyLateEntryForm.setItemValue("Att_Lt_Type", recordData.Att_Lt_Type);
                    applyLateEntryForm.setItemValue("Att_Lt_Hour", recordData.Att_Lt_Hour);
                    applyLateEntryForm.setItemValue("Att_Lt_Minute", recordData.Att_Lt_Minute);
                    applyLateEntryForm.setItemValue("Att_Lt_Reason", recordData.Att_Lt_Reason);
                }else{
                    // Set minimum selectable date to today for From Date
                    fromDate.setSensitiveRange(today, null);
                    // By default, set From Date and To Date to today's date
                    applyLateEntryForm.setItemValue("Att_Lt_From_Date", today);
                    applyLateEntryForm.setItemValue("Att_Lt_To_Date", today);
                    applyLateEntryForm.setItemValue("Att_Lt_NumOFDays", "1.0");
                }
                // Set To Date range: only 5 days from today's date initially
                var maxDate = new Date(today);
                maxDate.setDate(today.getDate() + 5);
                toDate.setSensitiveRange(today, maxDate);

                // When From Date is changed, reset To Date range accordingly
                fromDate.attachEvent("onClick", function (d) {
                    var selectedDate = fromDate.getDate();

                    var minDate = new Date(selectedDate);
                    var maxDate = new Date(selectedDate);
                    maxDate.setDate(minDate.getDate() + 5);

                    toDate.setSensitiveRange(minDate, maxDate);

                    // Optional: Reset To Date to the selected From Date by default
                    applyLateEntryForm.setItemValue("Att_Lt_To_Date", minDate);
                });
                    ...
                    if (name == 'CancelApplyLateEntry') {
                        ...
                        if (ApplyLvFrm) {
                            ...
                            applyLateEntryForm.send(preTally.Initialize.encryptURL("warehouse/applyLateEntry.php&" + params), function (loader, response) {
                                ...
                                var searchFromdate = myLateEntryToolBar.getValue("mylate_entry_date_from");
                                var searchTodate = myLateEntryToolBar.getValue("mylate_entry_date_till");
                                var params = "appFromDate=" + searchFromdate + "&appToDate=" + searchTodate;
                                LateEntryGrid.clearAndLoad(preTally.Initialize.encryptURL("requisites/listMyLateEntries.php&" + params));
                                applyLateEntryWin.close();
                                // Att_scheduler.clearAll();
                                // Att_scheduler.load(preTally.Initialize.encryptURL("requisites/AttendanceScheduler.php", "xml"));
                            });
        ...
        menuMyAttendance: function () {
            if (!dhxMiddleBlockTabs.cells("menuMyAttendance")) {
                ...
                dhxMiddleBlockLayout.cells("a").setWidth(1); //change width 200 to 1 04-07-2025
...
//                });
                ...
                //MyAttendanceTabbar.addTab("LateEntrySheet", "My Late Entries", 150);   // uncomment when enable late entry module  hidden on 20250715
                MyAttendanceTabbar.addTab("LateEntrySheet", "", 0);
                ...
                myattToolBar.setWidth("spacer", 650);
                myattToolBar.addButton("applyLeave", null, "Apply Leave", "new.gif");
                if (unescape(JGG1P3bDnUSDL26Mui7KzYjj30UjPdWxCCtGkJSHeuo) == 1) {
                    myattToolBar.addButton("", null, "&nbsp&nbsp|&nbsp&nbsp", "");  // uncomment when enable late entry module  hidden on 20250715
                }                
                myattToolBar.addButton("applyLateEntry", null, "Apply Late Entry <img src='images/icon/new-icon-2.gif' id='lateEntryImg' class='lateEntryImg' style='width: 14px;height: 14px;' />", "new.gif");
                if (unescape(JGG1P3bDnUSDL26Mui7KzYjj30UjPdWxCCtGkJSHeuo) != 1) {
                    myattToolBar.hideItem("applyLateEntry");   // uncomment when enable late entry module  hidden on 20250715
                }
                myattendance_year = Date.today().getFullYear(); 
                myattendance_month = Date.today().getMonth() + 1;

                var img = document.getElementById('lateEntryImg');

                // Get its parent div
                var parentDiv = img.parentElement;

                parentDiv.classList.add('lateEntryBtn');
...
//                            });
                ...
                myLateEntryToolBar = MyAttendanceTabbar.tabs("LateEntrySheet").attachToolbar();
                myLateEntryToolBar.setIconsPath("images/icon/default_18/");
                myLateEntryToolBar.addText("text_from", null, "FromDate");
                myLateEntryToolBar.addInput("mylate_entry_date_from", null, "", 75);
                myLateEntryToolBar.addButton("mylate_entry_df_clear", null, "", "close.gif");
                myLateEntryToolBar.addSeparator();
                myLateEntryToolBar.addText("text_till", null, "Todate");
                myLateEntryToolBar.addInput("mylate_entry_date_till", null, "", 75);
                myLateEntryToolBar.addButton("mylate_entry_dt_clear", null, "", "close.gif");
                myLateEntryToolBar.addSeparator();
                myLateEntryToolBar.addButton("mylate_entry_date_filter", null, "Search", "save.gif");
                myLateEntryToolBar.addText("spacer", '9', "");
                myLateEntryToolBar.disableItem("spacer");
                myLateEntryToolBar.setWidth("spacer", 220);
                myLateEntryToolBar.addButton("applyLateEntry", null, "Apply Late Entry", "new.gif");
                var myltTb_Inp_Frm = myLateEntryToolBar.getInput("mylate_entry_date_from");
                myltTb_Inp_Frm.setAttribute("readOnly", "true");
                myltTb_Inp_Frm.onclick = function () {
                    if (myLateEntryToolBar.getValue("mylate_entry_date_till"))
                        preTally.UserProfile.setSens(myltTb_Inp_Til, "max");
                }
                var myltTb_Inp_Til = myLateEntryToolBar.getInput("mylate_entry_date_till");
                myltTb_Inp_Til.setAttribute("readOnly", "true");
                myltTb_Inp_Til.onclick = function () {
                    if (myLateEntryToolBar.getValue("mylate_entry_date_from"))
                        preTally.UserProfile.setSens(myltTb_Inp_Frm, "min");
                }
                myltTb_Inp_Til = new dhtmlXCalendarObject([myltTb_Inp_Frm, myltTb_Inp_Til]);
                myltTb_Inp_Til.setDateFormat("%d.%m.%Y");
                myLateEntryToolBar.attachEvent("onClick", function (id) {
                    if (id == "applyLateEntry") {
                        preTally.UserProfile.applyLateEntry();
                    }
                    if (id == "mylate_entry_date_filter") {
                        var searchFromdate = myLateEntryToolBar.getValue("mylate_entry_date_from");
                        var searchTodate = myLateEntryToolBar.getValue("mylate_entry_date_till");
                        var params = "appFromDate=" + searchFromdate + "&appToDate=" + searchTodate;
                        LateEntryGrid.updateFromXML(preTally.Initialize.encryptURL("requisites/listMyLateEntries.php&" + params), true, true)
                        // Att_scheduler.clearAll();
                        // Att_scheduler.load(preTally.Initialize.encryptURL("requisites/AttendanceScheduler.php", "xml"));
                    }
                    if (id == "mylate_entry_df_clear") {
                        myLateEntryToolBar.setValue('mylate_entry_date_from', '', false);
                    }
                    if (id == "mylate_entry_dt_clear") {
                        myLateEntryToolBar.setValue('mylate_entry_date_till', '', false);
                    }

                });
                LateEntryLayout = MyAttendanceTabbar.tabs("LateEntrySheet").attachLayout("1C");
                LateEntryLayout.cells("a").hideHeader();
                LateEntryGrid = LateEntryLayout.cells("a").attachGrid();
                LateEntryGrid.enableColSpan(true);
                LateEntryGrid.enableTooltips("false,false,false,false,false,false,false,false,false,true");
                LateEntryGrid.loadXML(preTally.Initialize.encryptURL("requisites/listMyLateEntries.php"), function () {
                    // Att_scheduler.clearAll();
                    // Att_scheduler.load(preTally.Initialize.encryptURL("requisites/AttendanceScheduler.php", "xml"));
                    /*myLeaveGrid.attachEvent("onMouseOver", function(id,ind) { 
                     if(ind == 9) {
                ...
                AttForm.loadStruct(preTally.Initialize.encryptURL("requisites/attSignout.php"), function () {
                    ...
                    AttForm.attachEvent("onButtonClick", function (name) {
                        if (name == 'MarkSignOut') {
                            ...
                            preTally.Settings.progressOn(true, dhxLayout, null);
                            AttForm.send(preTally.Initialize.encryptURL("warehouse/attendance.php")+"&d="+RGV2aWNlVW5pcXVlSWQ, function (loader, response) {
...
//                                    $('.tb_l_days').html("Leaves : " + AttGrid.getUserData("", "leave_days") + " ");
                            ...
                            uuid = '0';
                            if(window.localStorage)uuid=localStorage.getItem('uuid');
                            AttForm.setItemValue("uuid", uuid);
                            AttForm.send(preTally.Initialize.encryptURL("warehouse/attendance.php")+"&d="+RGV2aWNlVW5pcXVlSWQ, function (loader, response) {
//                                AttGrid.updateFromXML(preTally.Initialize.encryptURL("requisites/listAttendance.php"), true, true, function () {
////                                    $('.tb_f_days').html("Full Day: " + AttGrid.getUserData("", "full_days") + " ");
////                                    $('.tb_h_days').html("Half Day: " + AttGrid.getUserData("", "half_days") + " ");
