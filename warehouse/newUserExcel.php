<?php
/* File for adding users through excel uploading */
...
if($excelData != 0 && $excelData != null) {
    $ExcelObj->newUserExcel($excelData,$preTally_user_id,$preTally_user_ofid);
    echo json_encode($ExcelObj->userErrorArray);
}
exit;