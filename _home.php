...
<!--[if (gt IE 9)|!(IE)]><!--> <html class=""> <!--<![endif]-->
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            ...
            <script type="text/javascript" src="scripts/preTally.Main.js?a=12"></script>
            <script type="text/javascript" src="scripts/preTally.Initialize.js?a=01"></script>
            <script type="text/javascript" src="scripts/preTally.Settings.js?a=21"></script>
            <script type="text/javascript" src="scripts/preTally.UserProfile.js?a=11"></script>
            <script type="text/javascript" src="scripts/preTally.BalanceSheet.js?a=03"></script>
            <script type="text/javascript" src="scripts/preTally.Item.js?a=13"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.MasterReports.js?a=24"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.CashBalanceSheet.js?a=22"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.BranchBSReports.js?a=18"></script>
            <script type="text/javascript" src="scripts/preTally.Track.js?a=11"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.Data.js?a=2"></script>
            <script type="text/javascript" src="scripts/preTally.Menu.js?a=9"></script>
            <script type="text/javascript" src="scripts/preTally.Validate.js?a=1"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.BulkUpload.js?a=4"></script>
            <script type="text/javascript" src="scripts/preTally.ManageTracks.js?a=1"></script>
            ...
            <script type="text/javascript" src="scripts/preTally.MyBankBook.js"></script>
