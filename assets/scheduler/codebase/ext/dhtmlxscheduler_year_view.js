...
scheduler.config.year_x = 4, scheduler.config.year_y = 3, scheduler.xy.year_top = 0, scheduler.templates.year_date = function (e) {
    ...
    function () {
        ...
        var r = scheduler.render_data,
            s = scheduler.date.date_to_str("%Y/%m/%d"),
        ...
        scheduler.clear_view = function () {
            ...
            for (var d = this.getEvents(e, this.date.add(e, 1, "day")), n = "", i = 0; i < d.length; i++) {
                ...
                if (this.filter_event(l.id, l)) {
                    var _ = l.color ? "background:" + l.color + ";" : "",
                        o = l.textColor ? "color:" + l.textColor + ";" : "";
            ...
            var s = Math.floor(parseInt(t.style.width) / r.year_x),
                a = Math.floor((parseInt(t.style.height) - scheduler.xy.year_top) / r.year_y);
            ...
            for (var o = this.date[this._mode + "_start"](this.date.copy(this._date)), c = o, h = null, _ = 0; _ < r.year_y; _++)
                for (var u = 0; u < r.year_x; u++) {
        ...
        scheduler.getActionData = function (t) {
            ...
            var r = t ? t.target : event.srcElement,
                s = scheduler._get_year_month_date(r),
                a = scheduler._get_year_month_cell(r),
                d = scheduler._get_year_day_indexes(a);
            return d && s ? (s = scheduler.date.add(s, d.week, "week"), s = scheduler.date.add(s, d.day, "day")) : s = null, {
                date: s,
                section: null
            }
        ...
        scheduler._locate_event = function (e) {
            ...
            if (!t) {
                ...
                var s = scheduler.templates.xml_date(r.getAttribute("date")),
                    a = scheduler.getEvents(s, scheduler.date.add(s, 1, "day"));
