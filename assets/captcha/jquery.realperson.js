...
function RealPerson() {
	this._defaults = {
		...
		regenerate: '<img src="images/refresh.png" />', // Instruction text to regenerate
...
$.extend(RealPerson.prototype, {
	...
	_generateHTML: function(target, inst) {
		...
		var html;
		html = '<div class="realperson-challenge" style="float:right; margin-top:10px;"><div class="realperson-text" style="float:left;">';
		...
		html += '</div><div class="realperson-regen" style="float:left; padding-left:10px;">' + inst.settings.regenerate +
