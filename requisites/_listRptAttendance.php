...
if($_REQUEST["Filters"]){
    ...
    foreach($AttLv as $rows){
        ...
        $leave_headers .= '{width:50,  type:"ro",   align:"center",  sort:"na", value:"'.$LT_Name[0].'L"},';        
        $LT_Id .= $rows->LT_Id;
        $LT_Id .= ",";
    }
    $LT_Ids = rtrim($LT_Id,","); 
   /* foreach($AttLv as $rows){
    ...
    $leave_headers .= '{width:110,  type:"ro",   align:"center",  sort:"na", value:"Salary Deductable Leaves"},';
    $attendance_headers .= '{width:110,  type:"ro",   align:"center",  sort:"na", value:"Attendance Time Details"}';                          
                /*}*/  
...
echo '{
    ...
    if($_GET["posStart"] == 0 && $_GET["calltype"] != "upd"){
        ...
        echo '
            ...
            head:[
            {width:50,  type:"ed", align:"center", sort:"na", value:"SlNo"},
            {width:180, type:"ro", align:"left",   sort:"na", value:"Name"},
        ...
        echo '{width:75, type:"ro", align:"center", sort:"na", value:"Full Day"},
              {width:75, type:"ro", align:"center", sort:"na", value:"Half Day"},
              {width:75, type:"ro", align:"center", sort:"na", value:"Total Leaves"},
              ';
              $LT_Id = "";
        echo $leave_headers;  
