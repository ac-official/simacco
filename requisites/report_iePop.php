...
//$curField = $updateFields[$SHID];//print_r($BS_Items);
    ...
    $formData .= '{type: "fieldset", name:"fieldsetname", class: "mydata",  label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.Reports.hideDetailData()\' />", width:"auto", list:[';
...
/*} else {
    ...
    $formData1 .= '{type: "fieldset", name:"fieldsetname", label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.Reports.hideDetailData()\' />", width:"auto", list:[';
