...
echo '<items>
        <item type="settings" position="label-left" labelWidth="80" inputWidth="100" offsetLeft="10" />
            <item type="fieldset" name="fieldset1" labelWidth="10" position="label-right" label="Filters" inputWidth="625">    
                ...
                <item type="newcolumn" offset="0"></item>  
                <item type="combo" name="TypeFilter" inputWidth="80" label="Type" offsetRight="40" >
            ...
            <item type="fieldset" name="fieldset2" labelWidth="250" inputWidth="625" position="label-right" label="Export Columns">
                <item type="checkbox" checked="true" position="label-right" name="Type" label="Type" offsetRight="50"></item> 
                <item type="checkbox" checked="true" position="label-right" name="Name" label="Name of Income/Expense" offsetRight="50"></item> 
                <item type="newcolumn" offset="0"></item>
                ...
                <item type="checkbox" checked="true" position="label-right" name="BS_Date" offsetLeft="50" label="Date"></item> 
