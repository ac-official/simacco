...
echo '<rows>';
    ...
    <column width="150"  sort = "na" type="ro" align="left" ><![CDATA[<div><div id="stateFlt" style="width: 70%;float:left;" placeholder="City"></div><div style="float:left;margin-left:3px;margin-top:3px;"><img src="images/icon/sort-ascending-icon.png" title="Click here to Sort" colNum="1" class="tkSt_Sort_BIR"/></div></div>]]></column>';
            ...
            echo '<row id = "'.$rw->ST_Id.'">
                ...
                for($y = $toYear; $y >= $fromYear; $y--) {
                    ...
                    for($i = $monthLimit; $i >= $month; $i--) {
                        ...
                        echo $amount        = ($AtObj->StateMonthReportArray[$rw->ST_Id][$y][$monthLimit]) ? $AtObj->StateMonthReportArray[$rw->ST_Id][$y][$monthLimit] : 0;
