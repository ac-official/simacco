...
include_once($BASEPATH . "preTallyClass/BussRptClass.php");
...
$BusinessObj->ocBarChartCashData($REQUEST['r'],$REQUEST['f'],$REQUEST['t'],$filter);
$RP_Obj = $BusinessObj->BusinessArray;
...
if($iOthers > 0) {
    $incData .= ' { "id":"10", "amount":"'.$iOthers.'", "title":"Others", "color": "'.$color[10].'", "category": "Others (<a href=\'javascript:void(0);\' onclick=\'preTally.BusinessReport.chartOtherDetails(1);\' ><img src=\'images/icon/expand_icon.png\' /> View More</a>)"},';
}
if($eOthers > 0) {
    $expData .= ' { "id":"10", "amount":"'.$eOthers.'", "title":"Others", "color": "'.$color[10].'", "category": "Others (<a href=\'javascript:void(0);\' onclick=\'preTally.BusinessReport.chartOtherDetails(2);\' ><img src=\'images/icon/expand_icon.png\' /> View More</a>)"},';
}
