...
echo '<items>
	<item type="settings" position="label-left" labelWidth="120" inputWidth="150" noteWidth="150" offsetLeft="20"/>
       <item type="calendar" name="LR_FromDate" label="From Date" readonly="true" required="true">
            <note width="150">From Date</note>
        </item>
        <item type="calendar" name="LR_ToDate" label="To Date" readonly="true" required="true">
            <note width="150">To Date</note>
        </item>
        <item type="combo" name="LT_Id" label="Type Of Leave"  connector="requisites/leaveType.php" validate="NotEmpty" readonly="true"  required="true">
			<note width="150">choose leaveType</note>
        </item>
