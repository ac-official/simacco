...
/*if($REQUEST['SHID']!=58 && $REQUEST['SHID']!=59){*/
    ...
    $formData .= '{type: "fieldset", name:"fieldsetname", class: "mydata",  label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.BranchBSReports.hideDetailData()\' />", width:"auto", list:[';
    ...
    if($BS_Obj[0]->BS_BRemarks){
    $formData .= ' { type : "template", name : "BS_BRemarks", label : "Bank Book Remarks : ", value : "<b>'.wordwrap($BS_Obj[0]->BS_BRemarks,25,"<br>").'</b>" },';
    }
    if($REQUEST['SHID']==58 || $REQUEST['SHID']==59){
...
/*} else {
    ...
    $formData1 .= '{type: "fieldset", name:"fieldsetname", label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.BranchBSReports.hideDetailData()\' />", width:"auto", list:[';
