...
/*if($REQUEST['SHID']!=58 && $REQUEST['SHID']!=59){*/
    ...
    // End 02-06-2025
        ...
        $formData .= '{type: "fieldset", name:"fieldsetname", class: "mydata",  label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.CashBalanceSheet.hideDetailData()\' />", width:"auto", list:[';        
        $i = 1;
...
/*} else {
    ...
    $formData12 .= '{type: "fieldset", name:"fieldsetname", label: "<img src=\'images/icon/close_button_icon.png\' style=\'cursor:pointer;\' onclick=\'preTally.CashBalanceSheet.hideDetailData()\' />", width:"auto", list:[';
