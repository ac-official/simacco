...
$ItemObj->getItemList("IT.IT_Id, IT.IT_Name","as IT, main_heads as MH, sub_heads as SH ","  WHERE ( IT.IT_Status = 1 || IT.IT_Status = 3 ) AND IT.SH_Id=SH.SH_Id AND SH.MH_Id=MH.MH_Id AND MH.MH_Type = ".$type." AND (IT.OF_Id=".$preTally_user_ofid." OR IT.IT_Id IN (".$itemMap.")) ORDER BY IT_Name ");
