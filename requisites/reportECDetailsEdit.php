...
echo '[{type: "settings",position: "label-left", labelWidth: "130", inputWidth: "200", offsetLeft:"20", noteWidth : "10"},';  
echo '{
        type		: "hidden",
        name		: "BS_Id",
        value		: "'.$BSID.'"
    ...
    echo '{type: "fieldset", label: "DETAILS ", inputWidth: "auto", width : "800", list:[ ';
        ...
        echo '{ type : "calendar", name: "BS_Date", label:"Created Date", value:"'.$BS_Obj[0]->BS_Date.'", inputWidth: "100" },';echo '{ type:"newcolumn"},';
        /*if($BS_Obj[0]->IT_PettyCash == 1)$amount = $BS_Obj[0]->BS_PettyCashAmt;else*/ $amount= $BS_Obj[0]->BS_Amount ; 
        echo '{ type : "input", name: "BS_Amount", label:"Amount", value:"'.$amount.'" , labelWidth: "100"},';
//            echo '{ type : "input", name: "BS_Amount", label:"Amount", value:"'.$BS_Obj[0]->BS_Amount.'" },';
        echo '{ type : "hidden", name: "LC_Id_Old", label:"", value:"'.$BS_Obj[0]->LC_Id.'" },';
    ...
    echo '{type : "fieldset", label : "AMOUNT DETAILS" , inputWidth: "auto", width : "800", list : [';
        echo '{type : "calendar", name : "FDate" , label : "From Date", inputWidth: "190" },{type : "newcolumn"},';
        echo '{type : "calendar", name : "TDate" , label : "Till Date", value : "" , inputWidth: "190"},{type : "newcolumn"},';
        echo '{type : "checkbox", name : "EditDS" , label : "", labelWidth: "15",info : "true" , tooltip : "Check this to override the defined values" ,position: "label-right"},{type : "newcolumn"},';
        echo '{type : "input", name : "BS_MinAmount" , label : "Minimum Amount" , value:"'.$BS_Obj[0]->BS_MinAmount.'" , inputWidth: "190"},{type : "newcolumn"},';
        echo '{type : "input", name : "BS_MaxAmount" , label : "Maximum Amount" , value:"'.$BS_Obj[0]->BS_MaxAmount.'" , inputWidth: "190"},{type : "newcolumn"},';
        echo '{type : "hidden", name: "BS_ExpenseControl", label:"", value:"1" },';
    echo ']},';
...
foreach ($sortArray as $key => $value) {        
    ...
    // start @ 10-06-2025 set the other branch cbo
    if ( $key=="payment" ) {
