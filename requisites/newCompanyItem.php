...
echo '<items>
	<item type="settings" position="label-left" labelWidth="120" inputWidth="400" noteWidth="180" offsetLeft="20"/>
		...
		<item type="hidden" name="IT_Id" value="0"/>
                ...
                <item type="button" name="addDescription" value=" + " className="descClass" tooltip= "Click to Add new Description for Same Item." offsetLeft ="145"></item>
		...
		<item type="input" name="IT_Comments" label="Remarks" value="" rows="3">
			<note width="150">Remarks</note>
                ...
                if($offAdm == $preTally_user_id) {
                    ...
                    <item type="checkbox" name="IT_Transfers" position="label-left"  label="Internal Transfers"></item>
                    </item>';
                } else {
